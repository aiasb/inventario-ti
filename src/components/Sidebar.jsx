...
import {
  LayoutDashboard, Package, Tags, BarChart3, Settings,
  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center gap-3 px-4 py-5 border-b border-slate-700/60 ${collapsed ? 'justify-center' : ''}`}>
        <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-blue-500 shrink-0">
          <Monitor size={18} className="text-white" />
        </div>
        {!collapsed && (
          <div>
            <p className="text-sm font-semibold text-white leading-tight">Inventário TI</p>
